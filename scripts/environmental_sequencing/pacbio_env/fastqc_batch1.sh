...
#SBATCH --output=log/environmental_sequencing/pacbio_env/fastqc_batch1_%A_%a.out
#SBATCH --error=log/environmental_sequencing/pacbio_env/fastqc_batch1_%A_%a.err
