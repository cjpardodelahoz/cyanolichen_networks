...
#SBATCH --output=log/environmental_sequencing/pacbio_env/trim_orient_relabel_batch1_%A_%a.out
#SBATCH --error=log/environmental_sequencing/pacbio_env/trim_orient_relabel_batch1_%A_%a.err
