...
#SBATCH --output=log/environmental_sequencing/pacbio_env/kraken_pipeline_unoise.out
#SBATCH --error=log/environmental_sequencing/pacbio_env/kraken_pipeline_unoise.err
