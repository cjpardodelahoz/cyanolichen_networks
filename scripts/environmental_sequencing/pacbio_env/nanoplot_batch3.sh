...
#SBATCH --output=log/environmental_sequencing/pacbio_env/nanoplot_batch3_%A_%a.out
#SBATCH --error=log/environmental_sequencing/pacbio_env/nanoplot_batch3_%A_%a.err
