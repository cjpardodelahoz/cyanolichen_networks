...
abmi_ref_ids <- read_csv("data/tables/nostoc_datas1c.csv") %>%
...
voucher <- read_csv("analyses/lichen_sequencing/ont_lichen/id/lichen_voucher_jm.csv") %>%
...
write_csv(voucher, "analyses/lichen_sequencing/ont_lichen/id/lichen_voucher_jm_curated_v0.csv")
